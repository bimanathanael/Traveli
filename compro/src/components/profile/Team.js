                    ...
                    <div className="col-md-7 text-center">
                        <ScrollAnimation animateIn='zoomIn'>
                            ...
                            <p className="descTeam">
                                TCN didukung oleh para tenaga ahli yang berpengalaman di 
                                bisnis perjalanan dan kepariwisataan, termasuk tim pengembang 
                                ecommerce yang handal serta dilengkapi dengan tim layanan pengguna 
                                yang siap melayani 24/7.
                            </p>
                        </ScrollAnimation>
                    </div>
                </div>
