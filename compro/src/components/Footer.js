        ...
        <div className="container-footer text-white">
          <div className="row oneRem">
            ...
            <div className="col-md-5 offset-md-1 no-mobile">
              <div className="row">
                <div className="col-md-4">
                  ...
                  <br/>
                  <a  className="text-white" href="/ContactUs"> Contact Us </a>
                  <br/>
                  <a  className="text-white" href="/Promo"> Promo </a>
                </div>
                <div className="col-md-4">
                  <b> Members </b>
                  <br/>
                  <br/>
                  <a  className="text-white" href="/supplier"> Supplier </a>
                  <br/>
                  <a  className="text-white" href="/Wholesaler"> Wholesaler </a>
                  <br/>
                  <a  className="text-white" href="/Reseller"> Reseller </a>
                  <br/>
                  <a  className="text-white" href="/TraveliKuy"> TraveliKuy </a>
                  <br/>
                  <a  className="text-white" href="/SupplierList"> Supplier List </a>
                  <br/>
                  <a  className="text-white" href="/WholesalerList"> Wholesaler List </a>
                </div>
                <div className="col-md-4">
                  <b> Privacy Policy </b>
                  <br/>
            ...
            <div className="col-md-3 text-right mobile-center mobile-top-margin">
              <b className="no-mobile"> 
                {data.ContactInformation.CompanyName}
              </b>
